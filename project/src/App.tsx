          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-4 gap-8">
              <div>
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold">Golden Hills</h3>
                    <p className="text-xs text-yellow-400 font-medium">INDIA</p>
                  </div>
                </div>
                <p className="text-gray-400 mb-6">
                  Transforming businesses worldwide with AI-powered solutions and cutting-edge technology.
                </p>
              ...
              <div>
                ...
                <ul className="space-y-3 text-gray-400">
                  <li><a href="#" className="hover:text-white transition-colors">Finance & Banking</a></li>
            ...
            <div className="border-t border-gray-800 mt-12 pt-8 text-center">
              <p className="text-gray-400">
                © 2025 Golden Hills India. All rights reserved. | ISO 27001 Certified | GDPR Compliant
              </p>
            </div>
          </div>
        </div>
