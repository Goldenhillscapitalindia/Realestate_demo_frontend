...
const MarketRadarFooter: React.FC<MarketRadarFooterProps> = ({ count, lastUpdated }) => (
  <div
    className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-slate-200 px-6 py-3 text-xs text-slate-600 shadow-[0_12px_30px_rgba(15,23,42,0.05)]"
    style={{
      background:
  ...
  >
    <div className="flex items-center gap-6">
      <span className="text-slate-700">{count} markets tracked</span>
      <span>
        Last updated:{" "}
